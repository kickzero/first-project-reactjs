...
export default function ArticleItemInfo({ isShowAvatar, authorAvatar, authorName, pubDate }) {
  return (
    <div className="article-item__info">
      {isShowAvatar && <ArticleItemAvatar authorName={authorName} authorAvatar={authorAvatar} />}
