...
export const ERRORS_MESSAGE = {
  ...
  rest_user_invalid_password: ['Mật khẩu không được bỏ trống!', 'Mật khẩu mới không được bỏ trống!', 'Mật khẩu cũ không đúng. Vui lòng thử lại.'],
  rest_user_invalid_username: 'Username chỉ chứa các ký tự a-z, 0-9 và ký tự gạch chân "_"',
