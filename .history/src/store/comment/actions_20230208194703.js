...
export function actFetchCommentsChild({ authorId, content, postId, parent }) {
  return {
...
export function actFetchNewItemAsyncAsync({ page = 1, post = null, parent = 0 }) {
...
export function actFetchNewItemAsync({ comments, total, totalPages, currentPage, parent }) {
  return {
    type: ACT_FETCH_COMMENTS_CHILD,
    payload: {
      comments,
